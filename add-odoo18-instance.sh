#!/bin/bash
################################################################################
# Script to add an Odoo 18 instance to an existing server setup
#-------------------------------------------------------------------------------
# This script checks which instances are already installed, identifies available
# ports, and adds a new Odoo 18 instance with the chosen configuration.
#-------------------------------------------------------------------------------
# Usage:
# 1. Save it as add-odoo18-instance.sh
...
BASE_ODOO_PORT=8069
BASE_GEVENT_PORT=9069  # Base port for gevent (websocket)
